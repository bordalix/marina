import type { MakeRefundTransactionParams } from '../src/pkg/boltz';
import { Boltz } from '../src/pkg/boltz';
...
describe('Boltz Atomic Swap', () => {
  ...
  it('should create a refund transaction', () => {
    const boltz = new Boltz('testnet');
  ...
  it('should extract correct information from redeem script', () => {
    const boltz = new Boltz('testnet');
